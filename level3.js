document.addEventListener("DOMContentLoaded", function() {
    ...
    const hazardousPile = document.getElementById('hazardous-pile');
    ...
    hazardousPile.addEventListener('dragover', dragOver);
    hazardousPile.addEventListener('dragenter', dragEnter);
    hazardousPile.addEventListener('dragleave', dragLeave);
    hazardousPile.addEventListener('drop', drop);
    ...
    function checkPiles() {
        ...
        const hazardousPileContents = Array.from(hazardousPile.children).map(child => child.id);
